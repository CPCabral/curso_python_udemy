"""
Crie uma função que encontra o primeiro duplicado considerando o segundo número como duplicação, retorne a duplicação considerada.
Requisitos:
...
def primeiro_duplicado(lista):
    ...
    for elemento in lista:
        ...
        if elemento in lista_elemento_unico:
